...
REM *** (1) CURRENT VERSION OF PACKAGE                        ***
REM ***                                                       ***
set DesiredVersion=14.12.0.18020
REM ***                                                       ***
REM *** (2) PACKAGE LOCATION/DEPLOYMENT DIRECTORY             ***
REM ***                                                       ***
set DeployDirectory=\\wfsrlitdlz01.it-dlz.saarland.de\CitrixClient$\Receiver_4.12_test
REM ***                                                       ***
REM *** (3) SCRIPT LOGGING DIRECTORY                          ***
REM ***                                                       ***
set logshare=\\wfsrlitdlz01.it-dlz.saarland.de\CitrixClient$\Install_Logs\
REM ***                                                       ***
REM *** (4) PACKAGE INSTALLER COMMAND LINE OPTIONS            ***
REM ***                                                       ***
set CommandLineOptions=/silent /includeSSON /ALLOWADDSTORE=S /STORE0="Store;https://storefront.saarland.de/Citrix/Store/discovery;on;IT-DLZ"
REM ***                                                       ***
REM ***                                                       ***
REM *************************************************************
REM *************************************************************
